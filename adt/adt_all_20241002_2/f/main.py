...
i_min_1 = max(1, A + k_min_1)
i_max_1 = min(N, A + k_max_1)
j_min_1 = max(1, B + k_min_1)
j_max_1 = min(N, B + k_max_1)

k_min_2 = max(1 - A, B - N)
k_max_2 = min(N - A, B - 1)
i_min_2 = max(1, A + k_min_2)
i_max_2 = min(N, A + k_max_2)
j_min_2 = max(1, B - k_min_2)
j_max_2 = min(N, B - k_max_2)

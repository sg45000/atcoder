...
cross = from_grid_gs(lambda x: x == "#", grid)
centers = [c for c in cross if is_center(c, cross)]

ans = [0] * min(H, W)
for c in centers:
    ans[cross_length(c, cross) - 1] += 1
